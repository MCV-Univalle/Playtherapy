...
public class TrajectoryPredictor : MonoBehaviour
{
    ...
    Transform hitMarker;
    [SerializeField, Range(10, 200), Tooltip("The maximum number of points the LineRenderer can have")]
    int maxPoints = 50;
    ...
    public void PredictTrajectory(ProjectileProperties projectile)
    {
       ...
       // velocity.y = Mathf.Tan(transform.eulerAngles.x * Mathf.Deg2Rad) * projectile.initialSpeed;  // Ajuste en Y
        ...
        {
            // Estimar la velocidad y actualizar la siguiente posición prevista
            velocity = CalculateNewVelocity(velocity, projectile.drag, increment);
            nextPosition = position + velocity * increment;

            // Solapamos los rayos con un pequeño margen para asegurarnos de que nunca nos perdemos una superficie
            overlap = Vector3.Distance(position, nextPosition) * rayOverlap;

            //Cuando choca con un collider, para y muestra el hitmarker
            ...
            //Si no choca con ningu  collider continua el rastro sin ningun  hitmarker
    ...
    private void MoveHitMarker(RaycastHit hit)
    {
        ...
        // Offset marker de la superficie
        float offset = 0.025f;
